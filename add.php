  ...
  <div class="container mt-4">
    ...
    <form action="add.php" method="post" name="form1">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" id="exampleInputKelas1" placeholder="Enter Kelas" name="Kelas" value="<?php echo isset($Kelas) ? $Kelas : '7'; ?>" required>
      </div>
    ...
    if (isset($_POST['Submit'])) {
      ...
      if (!empty($Nama) && !empty($Kelas) && !empty($Alamat)) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO website (Nama, Kelas, Alamat) VALUES ('$Nama', '$Kelas', '$Alamat')");
